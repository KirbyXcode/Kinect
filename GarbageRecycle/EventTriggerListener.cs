...
public class TouchHandle
{
    ...
    public void CallEventHandle(GameObject _lsitener, object _args)
    {
        if (null != eventHandle)
        {
            eventHandle(_lsitener, _args, handleParam);
        }
    }
...

{
    ...
    public void SetEventHandle(EnumTouchEventType _type, OnTouchEventHandle _handle, object _param)
    {
        switch (_type)
        {
            case EnumTouchEventType.OnClick:
                ...
                onClick.SetHandle(_handle, _param);
                break;
            case EnumTouchEventType.OnDoubleClick:
                ...
                onDoubleClick.SetHandle(_handle, _param);
                break;
            case EnumTouchEventType.OnDown:
                ...
                onDown.SetHandle(_handle, _param);
                break;
            ...
            case EnumTouchEventType.OnEnter:
                ...
                onEnter.SetHandle(_handle, _param);
                break;
            case EnumTouchEventType.OnExit:
                ...
                onExit.SetHandle(_handle, _param);
                break;
            case EnumTouchEventType.OnDrag:
                ...
                onDrag.SetHandle(_handle, _param);
                break;
            case EnumTouchEventType.OnDrop:
                ...
                onDrop.SetHandle(_handle, _param);
                break;
            ...
            case EnumTouchEventType.OnDragEnd:
                ...
                onDragEnd.SetHandle(_handle, _param);
                break;
            case EnumTouchEventType.OnSelect:
                ...
                onSelect.SetHandle(_handle, _param);
                break;
            case EnumTouchEventType.OnUpdateSelect:
                ...
                onUpdateSelect.SetHandle(_handle, _param);
                break;
            case EnumTouchEventType.OnDeSelect:
                ...
                onDeSelect.SetHandle(_handle, _param);
                break;
            case EnumTouchEventType.OnScroll:
                ...
                onScroll.SetHandle(_handle, _param);
                break;
            case EnumTouchEventType.OnMove:
                ...
                onMove.SetHandle(_handle, _param);
                break;
        }
    }
}
